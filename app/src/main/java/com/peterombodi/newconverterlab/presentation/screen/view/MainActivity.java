...
import com.peterombodi.newconverterlab.presentation.screen.presenter.MainActivityPresenter;
import com.peterombodi.newconverterlab.utils.GeoCoderLoader;

import java.util.ArrayList;


public class MainActivity extends AppCompatActivity implements
    IMainActivity.IGetAction,
    ...
    private IMainActivity.IPresenter presenter;
    ...
    protected void onStart() {
        super.onStart();
// TODO: 22.11.2016 pause for job in case data downloading at the moment ?
    }

    @Override
    protected void onResume() {
        if (presenter==null) presenter = (IMainActivity.IPresenter) new MainActivityPresenter();
